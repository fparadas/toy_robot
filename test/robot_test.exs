defmodule ToyRobot.RobotTest do
  ...
  describe "when robot is facing north, and it has moved 1 space" do
    setup do
  ...
  describe "when robot is facing east, and it has moved north 1 space" do
    setup do
      {:ok, %{robot: %Robot{east: 0, north: 1, facing: :east}}}
    end
  ...
  describe "when robot is facing west, and it has moved north 1 space" do
    setup do
      {:ok, %{robot: %Robot{east: 0, north: 1, facing: :west}}}
    end
  ...
  describe "when robot is facing north, and it has moved east 1 space" do
    setup do
      {:ok, %{robot: %Robot{east: 1, north: 0, facing: :north}}}
    end
  ...
  describe "when robot is facing south, and it has moved east 1 space" do
    setup do
      {:ok, %{robot: %Robot{east: 1, north: 0, facing: :south}}}
    end
